 ...
 * @author Matheus
 */
@WebServlet(name = "AlterarEventos", urlPatterns = {"/alterar_eventos.do"})
public class AlterarEventos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlterarEventos</title>");            
            out.println("</head>");
            out.println("<body>");
             try {
