 ...
 * @author Matheus
 */
@WebServlet(name = "AlterarGastos", urlPatterns = {"/alterar_gastos.do"})
public class AlterarGastos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AlterarGastos</title>");            
            out.println("</head>");
            out.println("<body>");
              try {
