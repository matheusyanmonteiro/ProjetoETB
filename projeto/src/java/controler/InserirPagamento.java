 ...
 * @author Matheus
 */
@WebServlet(name = "InserirPagamento", urlPatterns = {"/inserir_pagamento.do"})
public class InserirPagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
               try{
             int divisao = Integer.parseInt(request.getParameter("divisao"));
             int quantidadeParcela = divisao;
             double desconto = Double.parseDouble(request.getParameter("desconto"));
             int eventos_id = Integer.parseInt(request.getParameter("eventos_id"));
                Eventos e = new Eventos();
                e.setId(eventos_id);
                
                Pagamento p = new Pagamento();
                p.setDivisao(divisao);
